...
local Tabs = {
		Sea1Tab = Window:Tab({ Title = "Sea 1 Only", Icon = "map" }),
	Sea2Tab = Window:Tab({ Title = "Sea 2 Only", Icon = "map" }),
	Sea3Tab = Window:Tab({ Title = "Sea 3 Only", Icon = "map" }),
...
elseif World3 then Boss = {"Stone","Hydra Leader","Kilo Admiral","Captain Elephant","Beautiful Pirate","Cake Queen","Longma","Soul Reaper","Rip Indra","Dough King","Cake Prince","Kitsune","Ancient Relic Boss","Tyrant of the Skies"}
end
...
Tabs.CreditsTab:DiscordInfo({
    Title = "VORTEX UNION", 
    Desc = "O script definitivo para Blox Fruits em 2026. Totalmente atualizado e otimizado.",
    Icon = "https://cdn.discordapp.com/icons/1400630289285517322/e3e3a6da8744cc9265aa2c494abd9174.png", 
    Subtitle = "Entre no nosso Discord para atualizações e suporte. O VORTEX UNION HUB é dedicado a oferecer a melhor experiência.",
    Online = 450,
    Members = 8500,
    Callback = function()
        ...
        RelzUILib:Notify({
            ...
            Content = "Link do convite copiado para a área de transferência!",
            Icon = "bell",
            Duration = 3
        })
    end
...
-- [[ 2026 NEW FARMS INJECTION ]]
local Sea3Section = Tabs.Sea3Tab:Section({ Title = "Third Sea Exclusives", Opened = World3 })
if World3 then
    Sea3Section:Toggle({ Title = "Auto Kitsune Island", Default = false, Callback = function(s) _G.AutoKitsune = s end })
    Sea3Section:Toggle({ Title = "Auto Mirage Island (Blue Gear)", Default = false, Callback = function(s) _G.AutoMirage = s end })
    Sea3Section:Toggle({ Title = "Auto Soul Guitar", Default = false, Callback = function(s) _G.AutoSoulGuitar = s end })
    Sea3Section:Toggle({ Title = "Auto CDK", Default = false, Callback = function(s) _G.AutoCDK = s end })
    Sea3Section:Toggle({ Title = "Auto Submerged Farm", Default = false, Callback = function(s) _G.AutoSubmerged = s end })
    Sea3Section:Toggle({ Title = "Auto Prehistoric Farm", Default = false, Callback = function(s) _G.AutoPrehistoric = s end })
end

local CombatSection = Tabs.CombatTab:Section({ Title = "Advanced PvP 2026", Opened = true })
CombatSection:Toggle({ Title = "Silent Aim (Prediction)", Default = false, Callback = function(s) _G.SilentAim = s end })
CombatSection:Toggle({ Title = "Smart Aimbot (Cam Lock)", Default = false, Callback = function(s) _G.Aimbot = s end })
CombatSection:Toggle({ Title = "Auto Bounty (Safe Hunt)", Default = false, Callback = function(s) _G.AutoBounty = s end })
CombatSection:Toggle({ Title = "Auto Dodge Skills", Default = false, Callback = function(s) _G.AutoDodge = s end })
