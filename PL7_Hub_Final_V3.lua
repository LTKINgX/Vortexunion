...
Tabs.CreditsTab:DiscordInfo({
    ...
    Members = 6400,
    Callback = function()
        setclipboard("https://discord.gg/BHDQzr2Hup")
        RelzUILib:Notify({
...
AutoLevelFarmToggle = AutoFarmSection:Toggle({
	...
	Desc = "Advanced Quest & Kill System",
	Default = false,
...
-- [[ ORGANIZED FEATURES BY SEA ]]
if World2 then
	local ExtraSea2 = Tabs.MainTab:Section({ Title = 'Sea 2 Features', Icon = 'anchor', Opened = false })
	Tabs.MainTab:Toggle({ Title = "Auto Travel Dressrosa", Callback = function(s) _G.TravelDres = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Factory Raid", Callback = function(s) _G.AutoFactory = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Done Bartilo Quest", Callback = function(s) _G.Bartilo_Quest = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Turn on Race V3", Callback = function(s) _G.RaceClickAutov3 = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Superhuman", Callback = function(s) _G.Auto_SuperHuman = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Sharkman Karate", Callback = function(s) _G.Auto_SharkMan_Karate = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Law Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Rengoku Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Dragon Trident", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Darkbeard", Callback = function(s) _G.AutoEctoplasm = s end })
end
if World3 then
	local ExtraSea3 = Tabs.MainTab:Section({ Title = 'Sea 3 Features', Icon = 'anchor', Opened = false })
	Tabs.MainTab:Toggle({ Title = "Auto Zou Quest", Callback = function(s) _G.AutoZou = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Done Citizen Quest", Callback = function(s) _G.CitizenQuest = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Cake Prince", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Bones", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Mirror", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Observation V2", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Turn on Race V4", Callback = function(s) _G.RaceClickAutov4 = s end })
	Tabs.MainTab:Toggle({ Title = "Auto ElectricClaw", Callback = function(s) _G.Auto_Electric_Claw = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Godhuman", Callback = function(s) _G.Auto_God_Human = s end })
	Tabs.MainTab:Toggle({ Title = "Auto SanguineArt", Callback = function(s) _G.snaguine = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Bigmom", Callback = function(s) _G.AutoEctoplasm = s end })
end
local ExtraGeneral = Tabs.MainTab:Section({ Title = 'General Features', Icon = 'plus', Opened = false })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Level", Callback = function(s) _G.Level = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Nearest", Callback = function(s) _G.AutoFarmNear = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Materials", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Ectoplasm", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Training Dummy", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Berry", Callback = function(s) _G.AutoBerry = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Chest", Callback = function(s) _G.AutoFarmChest = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Mastery Fruits", Callback = function(s) _G.FarmMastery_Dev = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Mastery Gun", Callback = function(s) _G.FarmMastery_G = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Mastery All Sword", Callback = function(s) _G.FarmMastery_S = s end })
	Tabs.MainTab:Toggle({ Title = "Accept Quests", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Soul Reaper [Fully]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Random Bones", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Try Luck Gravestone", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Pray Gravestone", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Unlock Dough dungeon", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Unlock Phoenix dungeon", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Teleport Barista Cousin", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Rainbow Colors", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Accept Rainbow Quest Faster", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Observation", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Upgrade Mink V3", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Upgrade Human V3", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Upgrade Skypiea V3", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Upgrade FishMan V3", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Valkyrie", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Unlocked Puzzle", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Initialize Attack [M1/Melee/Sword]", Callback = function(s) _G.Seriality = s end })
	Tabs.MainTab:Toggle({ Title = "Turn on Bypass Teleport", Callback = function(s) _G.Bypass = s end })
	Tabs.MainTab:Toggle({ Title = "Panic Mode", Callback = function(s) _G.Safemode = s end })
	Tabs.MainTab:Toggle({ Title = "Anti AFK", Callback = function(s) _G.AntiAFK = s end })
	Tabs.MainTab:Toggle({ Title = "Remove Hit VFX", Callback = function(s) _G.DistroyHit = s end })
	Tabs.MainTab:Toggle({ Title = "Remove Death & Respawned VFX", Callback = function(s) _G.DistroyHit = s end })
	Tabs.MainTab:Toggle({ Title = "Disable Notify", Callback = function(s) _G.DistroyHit = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Melee", Callback = function(s) _G.Auto_Melee = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Swords", Callback = function(s) _G.Auto_Melee = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Gun", Callback = function(s) _G.Auto_Melee = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Blox Fruit", Callback = function(s) _G.Auto_Melee = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Defense", Callback = function(s) _G.Auto_Melee = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Elite Quest", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Stop when got God's Chalice", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tushita Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Yama Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Get CDK [ Last Quest ]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Yama CDK", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tushita CDK", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Tween to Legendary Sword Dealer", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Pole V1", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Pole V2 [Patched]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Saw Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Saber Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Cybrog", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Usoap's Hat", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Bisento V2", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Warden Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Marine Coat", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Swan Coat", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Key Rengoku", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Long Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Black Spikey", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Dark Blade V3", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Midnight Blade", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Unlocked DonSwan", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Swan Glasses", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Canvendish Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Twin Hooks", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Serpent Bow", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Lei Accessory", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Valentine Gacha", Callback = function(s) _G.AutoValentineGacha = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Find Mirage Island", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tween To Highest Point", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Gear", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Change Transparency can see", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tween Advanced Fruit Dealer", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Mirage Chest", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Skull Guitar", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Farm Material Skull Guitar", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Look At Moon", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Pull Lever", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Train V4", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Teleport to Race Doors", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Complete Trial Race", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Kill Player After Trial", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Dojo Trainer", Callback = function(s) _G.Dojoo = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Dragon Hunter", Callback = function(s) _G.FarmBlazeEM = s end })
	Tabs.MainTab:Toggle({ Title = "Tween To Upgrade Droco Trial", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Drago (V1)", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Drago (V2)", Callback = function(s) _G.AutoFireFlowers = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Drago (V3)", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Relic Drago Trial", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Train Drago v4", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Tween to Drago Trials", Callback = function(s) _G.TpDrago_Prehis = s end })
	Tabs.MainTab:Toggle({ Title = "Swap Drago Race", Callback = function(s) _G.BuyDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Upgrade Dragon Talon With Uzoth", Callback = function(s) _G.DT_Uzoth = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Craft Volcanic Magnet", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Find Prehistoric Island", Callback = function(s) _G.Prehis_Find = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Patch Prehistoric Event", Callback = function(s) _G.Prehis_Find = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Dino Bones", Callback = function(s) _G.Prehis_Find = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Dragon Eggs", Callback = function(s) _G.Prehis_Find = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Reset When Complete Volcano", Callback = function(s) _G.UPGDrago = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Teleport Frozen Dimension", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Drive To Hydra Island", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Sail Boat", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Shark", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Piranha", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Terror Shark", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Fish Crew Member", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Haunted Crew Member", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Attack PirateGrandBrigade", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Attack Fish Boat", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Attack Sea Beast", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Attack Leviathan", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Find Kitsune Island", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Teleport to Shrine Actived", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Azure Ember", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Trade Azure Ember", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Select Dungeon Chip", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Start Raid", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Teleport To Lab", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Complete Raid [Safety]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Kill Aura", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Next Island", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Awakening", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Teleport to choose players", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Spectate Choose Players", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Aimbot Method Skills", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Aimbot Camera Closet Players", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Instance Mink V3 [ INF ]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Instance Energy [ INF ]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Instance Soru [ INF ]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Instance Observation Range [ INF ]", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Ignore Same Teams", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Accept Allies", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Berries", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Players", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Chests", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Fruits", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Island Location", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Flower", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Legendary Sword", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Aura Colour Dealers", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Gears", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp SeaEvent Island", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Esp Advanced Fruits Dealer", Callback = function(s) _G.AutoEctoplasm = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tween to NPCs", Callback = function(s) _G.TPNpc = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Random Fruit", Callback = function(s) _G.Random_Auto = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Drop Fruit", Callback = function(s) _G.DropFruit = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Store Fruit", Callback = function(s) _G.StoreF = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Tween to Fruit", Callback = function(s) _G.TwFruits = s end })
	Tabs.MainTab:Toggle({ Title = "Auto Collect Fruit", Callback = function(s) _G.InstanceF = s end })
	Tabs.MainTab:Toggle({ Title = "Unlock All Portals", Callback = function(s) _G.PortalUnLock = s end })
	Tabs.MainTab:Toggle({ Title = "Turn on Time", Callback = function(s) _G.daylightN = s end })
	Tabs.MainTab:Toggle({ Title = "Turn on Ice Walk", Callback = function(s) _G.WalkWater = s end })
