...
Tabs.CreditsTab:DiscordInfo({
    Title = "VORTEX UNION HUB",
    Desc = "The ultimate Blox Fruits script. Powerful, organized, and built for efficiency.",
    Icon = "rbxassetid://108924407900215", -- Vortex Union Icon Placeholder
    Subtitle = "Join our community for updates and support. Vortex Union Hub is dedicated to providing the best experience.",
    Online = 450,
    Members = 8200,
    Callback = function()
